...
public class LDrawElement4 extends LDrawElementBase {
	private static final long serialVersionUID = -6413282725740301452L;
	...
	public LDrawElement4(int color, Vector4 vec1, Vector4 vec2, Vector4 vec3, Vector4 vec4) {
		this.color = color;
		this.vec1 = vec1;
		this.vec2 = vec2;
		this.vec3 = vec3;
