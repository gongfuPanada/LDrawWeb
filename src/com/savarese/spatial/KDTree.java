...
// Got rid of Java reflection dependencies, since GWT doesn't support reflection on the client side.
  ...
  implements RangeSearchTree<Coord, P, V>
{
  ...
  abstract class CollectionView<E> implements Collection<E> {
   ...
   public <T> T[] toArray(T[] a) {
      ...
      if(array.length < size()) {
    	  ...
    	  /*ArrayList<T> t = new ArrayList<T>(size());
    	  array = t.toArray();
    	  a = (T[]) array;*/
      }
  ...
  public void optimize() {
    ...
    //ArrayList<KDNode> nodesa = new ArrayList<KDNode>(size());
    
    KDNode[] nodes = //(KDNode[]) nodesa.toArray();
